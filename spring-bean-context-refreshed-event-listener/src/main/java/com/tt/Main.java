...
/**
 * 演示 ApplicationListener&lt;ContextRefreshedEvent&gt; 监听容器启动完成事件。
 * <p>
 * finishRefresh() 发布事件后，监听器同步执行，refresh() 结束后容器才就绪。
 */
public class Main {

    public static void main(String[] args) {

        System.out.println("========== ApplicationListener<ContextRefreshedEvent> 演示 ==========");
        System.out.println();
